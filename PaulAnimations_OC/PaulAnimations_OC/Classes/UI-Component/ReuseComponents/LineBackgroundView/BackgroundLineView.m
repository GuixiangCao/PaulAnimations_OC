...
+(instancetype)lineBackgroundWithLength:(CGFloat)length;
@end
...
+(instancetype)backGroundLineWithFrame:(CGRect)frame lineWidth:(CGFloat)lineWidth lienGap:(CGFloat)lineGap lineColor:(UIColor *)lineColor rotate:(CGFloat)rotate{
...
-(void)drawRect:(CGRect)rect{
    ...
    CGFloat      outerX       = (drawLength - width) * 0.5;
    CGFloat      outerY       = (drawLength - height) * 0.5;
